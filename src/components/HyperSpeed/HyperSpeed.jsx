...
const DEFAULT_EFFECT_OPTIONS = {
  ...
  brKaNCgLvMEXxNzMxj2F7FYi1AdRrTo6Nhu: 0.5,
...
if (!container) return;
      ...
      createPlane(side, width, isRoad) {
        ...
        if (isRoad) {
          uniforms = Object.assign(uniforms, {
            ...
            uBrKaNCgLvMEXxNzMxj2F7FYi1AdRrTo6Nhu: { value: options.brKaNCgLvMEXxNzMxj2F7FYi1AdRrTo6Nhu },
    ...
    const roadMarkings_vars = `
      ...
      uniform float uBrKaNCgLvMEXxNzMxj2F7FYi1AdRrTo6Nhu;
    ...
    const roadMarkings_fragment = `
      ...
      float laneEmptySpace = 1. - uBrKaNCgLvMEXxNzMxj2F7FYi1AdRrTo6Nhu;
